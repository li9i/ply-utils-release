 ...
 * - Optionally preprocesses the point cloud (voxel grid downsampling and
...
private:
   ...
   */
  pcl::PolygonMesh poisson_reconstruction(
    pcl::PointCloud<pcl::PointNormal>::Ptr cloud_with_normals)
  {
    ...
    RCLCPP_INFO(this->get_logger(),
      "Poisson reconstruction complete. Vertices: %zu, Polygons: %zu",

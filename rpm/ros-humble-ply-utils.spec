...
Name:           ros-humble-ply-utils
Version:        0.0.1
Release:        1%{?dist}%{?release_suffix}
Summary:        ROS ply_utils package

License:        MIT
URL:            https://index.ros.org/p/ply_utils/#humble
...
Requires:       ros-humble-sensor-msgs-py
...
BuildRequires:  ros-humble-sensor-msgs-py
...
%description
ROS 2 utilities for PLY/XYZ/PointCloud2 conversion and TF2-based frame
transforms: ply_to_xyz and xyz_to_ply transframers (C++) and a pointcloud_to_ply
mesh reconstructor (Python/Open3D).
...
%changelog
* Sun Jun 07 2026 li9i <alexandros.filotheou@gmail.com> - 0.0.1-1
